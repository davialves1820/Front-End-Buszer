  ...
  return (
    <Layout currentPath="/admin">
      <div className="container mx-auto px-4 py-6 sm:py-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-foreground text-center mb-8 sm:mb-12">Painel Administrativo</h1>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-12">
            <StatsCard icon={Bus} value={stats.totalVehicles} label="Total de veículos" />
            <StatsCard icon={MapPin} value={stats.activeVehicles} label="Veículos Rodando" />
            <StatsCard icon={AlertTriangle} value={stats.inactiveVehicles} label="Veículos Inativos" />
            <StatsCard icon={User} value={stats.activeDrivers} label="Motoristas Ativos" />
          </div>
        )}
        ...
        {activeTab === 'fleet' ? (
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-4 sm:mb-6">Controle da Frota</h2>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-4 sm:mb-6">Notificações</h2>
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
